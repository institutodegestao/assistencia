...
Row {data-height=100 .tabset .tabset-fade}
-------------------------------------

### Solicitacoes por Unidade

```{r}
selectizeInput('selec_unid', 'Unidade', choices = (c('TODAS', sort(as.character(unique(hist_solic_nova$unidade_solicitante))))), selected = 'TODAS')
