...
# p1 <-
  ...
  #   header = list(values = c("Código da Solicitacao", "Solicitante"),
  #   fill = list(color = c("#A0D1FF", "#41A4FF")),
  #   font = list(family = "Arial", size = 14, color = "white")),
  #   cells = list(values = rbind(dt$cod_leito, leito_motivo$desc_saida_alteracao))
  # )
 DT::datatable(dt, options=list(scrollY = "250px"))
